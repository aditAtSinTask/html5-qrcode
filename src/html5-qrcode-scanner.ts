...
export class Html5QrcodeScanner {
  ...
  private createBasicLayout(parent: HTMLElement) {
    ...
    parent.style.boxShadow = "0 1px 15px -8px rgb(0 0 0 / 90%)";
    ...
    qrCodeScanRegion.style.minHeight = "100%";
    ...
    qrCodeDashboard.style.bottom = "0px";
  ...
  private createPermissionsUi(
    ...
    if (this.persistedDataManager.hasCameraPermissions()) {
      CameraManager.hasCameraPermissions()
  ...
  private insertCameraScanImageToScanRegion() {
    ...
    this.cameraScanImage.style.marginTop = "50%";
    this.cameraScanImage.style.width = "128px";
  ...
  private getFileScanInput(): HTMLInputElement {
    return <HTMLInputElement>(
      document.getElementById(this.getFileScanInputId())!
    );
  }
